...
class NotifyNewEmployeesRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'employee_list' => 'required|file|mimes:xls,xlsx|max:10240',
    ...
    public function messages(): array{
        return [
            ...
            'employee_list.required' => 'Het uploaden van een Excel-bestand is verplicht.',
            'employee_list.mimes' => 'Het bestand moet het XLSX of XLS-formaat hebben.',
            'employee_list.max' => 'Het bestand mag maximaal 10 MB groot zijn.',
